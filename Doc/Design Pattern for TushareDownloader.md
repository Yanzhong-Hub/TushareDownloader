# Design Pattern for TushareDownloader

## All Function Structure

- API layer
- Operation layer Only used in the corresponding API layer
- Database layer Only used in the corresponding Operation layer
